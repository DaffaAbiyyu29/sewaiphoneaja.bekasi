...
export default function EditPriceUnitDialog({
  isOpen,
  onClose,
  priceData,
  onSuccess,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `${API_URL}/api/unit/price/${priceData.price_id}`,
        formData,
        {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                <p className="text-sm text-blue-700">
                  <strong>💡 Info:</strong> Harga per hari akan dikalikan dengan
                  durasi untuk menghitung total biaya rental.
                </p>
              </div>
