    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-5 gap-4">
        <div className="flex items-center space-x-3 w-full md:w-auto">
          ...
          {allowAdd && (!isPrice || (isPrice && totalDataCount === 0)) && (
            <button
              onClick={onAddClick}
        ...
        {isSearch && (
          <div className="relative w-full md:max-w-xs">
            <input
              ...
              className="border border-gray-300 px-4 py-2 pr-10 rounded-lg w-full text-sm
               focus:ring-blue-900 focus:border-blue-900 transition duration-150
               shadow-sm focus:outline-none focus:ring-2 focus:border-transparent
               appearance-none"
            />
